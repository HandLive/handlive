...
**Trạng thái:** Phase 0 đã xong: khung, giao thức, mã hóa, token và CI. Ứng dụng chưa có tính năng cho người dùng. Mã nguồn nằm ở bốn kho riêng, clone vào thư mục này. Xem mục Cấu trúc. Sản phẩm đa ngôn ngữ: tiếng Anh là ngôn ngữ mặc định, tiếng Việt là ngôn ngữ thứ hai; mọi tài liệu ở đây có hai bản (`X.md` tiếng Anh, `X.vi.md` tiếng Việt).
