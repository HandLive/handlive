...
| 28 | Xác nhận hành động phá hủy | enum{Xóa khỏi máy chủ\| Xóa toàn bộ\| Hủy} | Input | — | Tiêu đề là một câu hỏi, trên mọi nền tảng: "Xóa thiết bị này khỏi máy chủ?" cho trường 26, "Xóa toàn bộ dữ liệu HandLive?" cho trường 27; nội dung là cảnh báo của trường 29. Nút xác nhận nêu đúng hành động, đi cùng "Hủy": "Xóa khỏi máy chủ" cho trường 26, "Xóa toàn bộ" cho trường 27; nút có màu cảnh báo |
