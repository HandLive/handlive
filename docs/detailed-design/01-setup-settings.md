...
| 28 | Destructive action confirmation | enum{Remove from Server\| Delete All\| Cancel} | Input | — | A question as the title, on every platform: "Remove This Device from the Server?" for field 26, "Delete All HandLive Data?" for field 27; the message is the field 29 warning. The confirm button names the action and sits next to "Cancel": "Remove from Server" for field 26, "Delete All" for field 27; it is warning-colored |
