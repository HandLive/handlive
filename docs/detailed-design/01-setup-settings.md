...
| 5 | A-SVC ongoing notification | string | Output | "Waiting for a connection" | Channel `hl_service`, `IMPORTANCE_LOW`; text updated per CONN-01 field 6; has a "Send Clipboard" button (CLIP-01 field 4) |
