...
| 3 | Hướng dẫn cấp quyền dán | string | Output | — | "Để tự gửi bảng nhớ tạm, mở Cài đặt hệ thống › Quyền riêng tư và bảo mật › Dán từ ứng dụng khác và chọn Luôn cho phép cho HandLive." kèm nút mở Cài đặt hệ thống |
