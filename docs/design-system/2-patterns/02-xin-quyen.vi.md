[English](02-xin-quyen.md) | Tiếng Việt
...
| Trạng thái Tập trung | macOS | Bật "Đổ chuông trên Mac" | Không cần | `NSFocusStatusUsageDescription`: "HandLive đọc trạng thái Tập trung để không đổ chuông và không hiện cuộc gọi khi bạn đang tập trung." Chưa cho phép thì không đổ chuông |
